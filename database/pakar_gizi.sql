...
--
-- Host: localhost
-- Generation Time: Jul 03, 2020 at 10:37 AM
...
CREATE TABLE IF NOT EXISTS `tblgejala_gizi` (
...
CREATE TABLE IF NOT EXISTS `tblkonsultasi` (
  ...
  `idtingkatgizi` varchar(9) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tblsolusi` (
...
CREATE TABLE IF NOT EXISTS `tbltingkatgizi_solusi` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbltingkat_gizi` (
  `id_tingkatgizi` varchar(5) NOT NULL,
  `nama_tingkatgizi` varchar(60) NOT NULL,
  PRIMARY KEY (`id_tingkatgizi`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
('eko', 'e5ea9b6d71086dfef3a15f726abcc5bf', 'eko', '43', 'Laki-laki', 'user', '0', '0', ''),
('dodi', 'dc82a0e0107a31ba5d137a47ab09a26b', 'dodi', '35', 'Laki-laki', 'user', '0', '0', ''),
('weezy', 'weezy', 'ismail ivendi', '22', 'laki-laki', 'user', '123', '33', 'sehat'),
('weezy', 'weezy', 'ismail ivendi', '22', 'laki-laki', 'user', '123', '33', 'sehat'),
